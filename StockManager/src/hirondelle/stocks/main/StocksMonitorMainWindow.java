 ...
 * this uses almost all classes in this package, either directly or indirectly.
 * <P>
...
final class StocksMonitorMainWindow implements Observer {
   ...
   * variable if possible, and upgrade to a field only if there is a good reason. 
  ...
  */
  ...
  private Action fFetchQuotesAction;
  ...
  */
  ...
  private void initActions() {
    ...
    java.util.List<PreferencesEditor> prefEditors = new ArrayList<PreferencesEditor>();
